...
def create_app(test_config=None):
    ...
    def sign_up():
        ...
        INSERT INTO usersname,email,profile,hashed_password) 
        VALUES (:name,:email,:profile,:hashed_password)"""), new_user).lastrowid
    ...
    def login():
        ...
        rew = database.execute(text("""
        SELECT id, hasher_password FROM users WHERE email = :email"""), {'email': email}).fetchone()
